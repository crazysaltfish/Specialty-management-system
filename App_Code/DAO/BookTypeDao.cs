...
namespace Dao
{
    ...
    public class BookTypeDao
    {
        ...
        {
            _sql = "select id, typeName from productType";
        ...
        {
            _sql =
                "if not exists(select id from productType where typeName = @typeName) begin insert into productType (typeName) values (@typeName) end";
        ...
        {
            _sql = "delete from productType where id = @id";
            SqlParameter[] parameters =
            {
